...
# 	export LD_LIBRARY_PATH="${TOOLCHAIN_DIR}/lib:${LD_LIBRARY_PATH}:/io/third_party/lib"
# 	MFLAG="-m32"
# else
# 	export LD_LIBRARY_PATH="${TOOLCHAIN_DIR}/lib64:${TOOLCHAIN_DIR}/lib:${LD_LIBRARY_PATH}:/io/third_party/lib"
# 	MFLAG="-m64"
# fi
...
for PYBIN in /opt/python/*/bin; do
    ...
    cd /io && "${PYBIN}/python" setup.py bdist_wheel -d `dirname $0`/../wheelhouse/
